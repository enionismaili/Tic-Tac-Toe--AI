...
class TicTacToeGUI:
    ...
    def choose_letter_and_strategy(self):
        ...
        # this loop prompts the player to choose the AI strategy (Smart AI or Random AI) until a valid choice is made
        while True:
            ...
            if strategy_choice == '1':
                ...
                # show an error message if the input is invalid (not '1' or '2')
